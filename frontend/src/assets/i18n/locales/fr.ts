export default {
  ...
  randomName: {
    adjectives: [
      ...
      'Volcanique', 'Indomptable', 'Fantastique', 'Formidable', 'Sympathique', 'Extraordinaire',
      'Habile', 'Agile', 'Solide', 'Héroïque', 'Épique', 'Galactique', 'Stellaire', 'Vorace',
      'Tenace', 'Sublime', 'Intrépide', 'Splendide',
    ],
  },
  footer: {
